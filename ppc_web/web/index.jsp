    ...
    <head>
        ...
        <script type="text/javascript">
            function initialize() {
                ...
                var image = 'http://www.purestudentliving.com/sites/default/files/Bus%20Station_1.png';
            ...
            <table style="display: inline-table;" border="0" cellpadding="0" cellspacing="0" width="1000">
                ...
                <tr>
                    ...
                    <td colspan="3" background="images/menu-original_r5_c3.jpg">
                        ...
                        <div style="position:absolute; top:130px; left:100px; height:500px; width:400px; background-color: #FF6600;">    
                            <div align="center" style="position: relative;">

                                <form name="input" action="" method="get">
                                    <b>Statie de plecare:</b>
                                    <input type="text" name="plecare" id="plecare" onkeyup="showData(this.value);" size="20"/>
                                    <div  id="suggestplecare" class="suggest" style="visibility:hidden;border:#000000 1px solid; position: fixed;"></div>

                                    <b>Statie de sosire:</b>
                                    <input type="text" name="sosire" id="sosire" onkeyup="showData(this.value)" size="20"/>
                                    <div id="suggestsosire" class="suggest" style="visibility:hidden;border:#000000 1px solid; position: fixed;"></div>


                                    <input type="button" value="Ruta" onClick="ruta()"/> 
                                </form>

                                <div id="ruta" align="center" style="height:350px; overflow: scroll;">
                    ...
                    <td rowspan="3" colspan="4">
                        <center>
                            <div id="map_canvas" style="width:900px; height:500px; position: absolute; top:130px; left: 500px;" ></div>
                        </center>
