function autoCompleteDB()
 ...
 autoCompleteDB.prototype.getMatches=function(str,aList,maxSize)
 {
    ...
    {
         if(this.aNames[i].toLowerCase().indexOf(str.toLowerCase()) > -1) /*looking for case insensitive matches */
       {
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    ...
    aNames = xmlhttp.responseText.split(",");
    //alert(aNames);
    new autoComplete(aNames,document.getElementById('plecare'),document.getElementById('suggestplecare'),15);
    new autoComplete(aNames,document.getElementById('sosire'),document.getElementById('suggestsosire'),15);
 }
 }
 
 
xmlhttp.open("GET","getstatii",true);
xmlhttp.send();
